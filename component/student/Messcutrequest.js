...
const Messcutrequest = () => {
    const today = new Date();
    // const currdate = today.getMonth();
    let dt = "", et = "";
    dt = today.getFullYear() + "-" + today.getMonth() + '-' + (today.getDate() + 2);
    et = today.getFullYear() + "-" + today.getMonth() + '-' + (today.getDate() + 7);
    function t() {
        console.log(dt);
    }
    useEffect(() => {
                            ...
                            <div className='left'>
                                <div className='form-wrapper'>
                                    <div className='contact-heading'>
                                        <h1 style={{ marginLeft: "60px" }}>Mess Cut Request<span>.</span></h1>
                                        {/* <p className='text'>Or reach us via: <a href='abinas@gmail.com'>abinash@gmail.com</a></p> */}
                                    </div>

                                    <form className='contact-form'>
                                        <div className='input-wrap'>
                                            <input className='contact-input' autoComplete='off' name='First Name' type='date' required />
                                            {/* <label>First Name</label> */}
                                            {/* <FontAwesomeIcon icon={faAddressCard} className='icon fa-soild fa-address-card' /> */}
                                        </div>

                                        <div className='input-wrap'>
                                            <input className='contact-input' autoComplete='off' name='Last Name' type='date' required />
                                    ...
                                    <div style={{ marginTop: '20px', marginLeft: '233px' }}>
                                        <input type='submit' name="Send Message" className='btn' onClick={t} />
                                    </div>
                                </div>
                            </div>
                            <div className='right'>
