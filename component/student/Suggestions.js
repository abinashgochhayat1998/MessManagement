...
const Suggestions = () => {
    ...
    function sendinput() {
        console.log(fname + " " + lname + " " + roll + " " + suggestions);
        // alert("hi cheta");
    };
    useEffect(() => {
                            ...
                            <div className='left'>
                                <div className='form-wrapper'>
                                    <div className='contact-heading'>
                                        <h1 style={{ marginLeft: "60px" }}>Any Suggestions<span>!!..</span></h1>
                                    ...
                                    <form className='contact-form'>
                                        ...
                                        <div className='input-wrap textarea w-100'>
                                            <textarea name='Message' onChange={(e) => setsuggestions(e.target.value)} autoComplete='off' className='contact-input' required />
                                    ...
                                    <div style={{ marginTop: '20px', marginLeft: '233px' }}>
                                        <input type='submit' onClick={sendinput} name="Send Message" className='btn' />
                                    </div>
                                </div>
                            </div>
                            <div className='right'>
